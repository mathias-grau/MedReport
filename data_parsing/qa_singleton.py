...
def get_qa_pipeline():
    ...
    if _qa_pipeline is None:
        ...
        tokenizer = AutoTokenizer.from_pretrained(Config.TOKENIZER_NAME, cache_dir='./app/')
        model = AutoModelForQuestionAnswering.from_pretrained(Config.QA_MODEL_NAME, cache_dir='./app').to(Config.DEVICE)
